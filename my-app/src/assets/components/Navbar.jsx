...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-white font-serif">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center py-4">
        <div className="w-24">
          <img
            src="https://websitedemos.net/food-blogger-04/wp-content/uploads/sites/793/2021/03/food-blogger-site-logo.svg"
        ...
        <div className="hidden md:flex space-x-8 text-lg font-medium">
          ...
          <Link to="/contact" className="block text-gray-900 hover:text-brown-600 transition">Contact</Link>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden px-4 pb-4 space-y-2">
          <Link to="/" className="block text-brown-600 font-semibold">Home</Link>
          <Link to="/about" className="block text-gray-900 hover:text-brown-600 transition">About</Link>
          <Link to="/contact" className="block text-gray-900 hover:text-brown-600 transition">Contact</Link>
          <div className="flex space-x-4 text-brown-600">
            <a href="#" className="hover:text-brown-900">
