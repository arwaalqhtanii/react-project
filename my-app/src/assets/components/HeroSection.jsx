    ...
    return (
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <p className="text-sm font-light text-brown-500 uppercase tracking-widest">Welcome</p>
            <br />
            ...
            <button className="mt-8 bg-white text-brown-500 border-brown-500 border-2 px-6 py-3  hover:bg-brown-500 hover:text-white transition">
              JOIN INSIDER
            </button>
          </div>
